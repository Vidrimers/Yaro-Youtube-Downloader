...
class TelegramHelper {
  ...
  async sendError(chatId, errorType, details = '') {
    const errorMessages = {
      ...
      instagram_login_required: '🔒 *Требуется авторизация*\n\n' +
                               'Этот контент Instagram требует входа в аккаунт.\n' +
                               'Попробуйте другую ссылку (публичный пост/reel).',
      
      instagram_unavailable: '❌ *Контент недоступен*\n\n' +
                            'Видео или пост Instagram недоступен.\n' +
  ...
  async sendWelcome(chatId) {
    const message = `👋 <b>Добро пожаловать!</b>\n\n` +
                   `Я помогу вам скачать видео с YouTube и Instagram.\n\n` +
                   `<b>Как использовать:</b>\n` +
                   `1️⃣ Отправьте ссылку на видео\n` +
                   `2️⃣ Выберите нужное качество (YouTube)\n` +
  ...
  async sendHelp(chatId) {
    const message = `📖 <b>Справка</b>\n\n` +
                   ...
                   `• 240p\n\n` +
                    `<b>Функции:</b>\n` +
                     `🎯 Автоматическое обнаружение рекламных блоков (YouTube)\n` +
                     ...
                     `   • 👀 Превью и анонсы\n` +
                     `   • 🎵 Музыка не по теме\n` +
                     `✂️ Обрезка видео по времени начала и конца (YouTube)\n` +
                    ...
                    `<b>Примечание:</b>\n` +
                    `• YouTube — полная поддержка (качество, реклама, обрезка)\n` +
                    `• Instagram — скачивание лучшего качества (reels, посты, stories)\n\n` +
                    `🌐 <b>Скачивание с других сайтов:</b>\n` +
                    `Если вы хотите скачать видео с сайта, который не поддерживается ботом, используйте расширение <b>Yaro Video Downloader</b> для браузера Chrome/Opera/Edge.\n` +
                    `Расширение поддерживает скачивание видео с любых сайтов, включая защищённые потоковые видео (HLS, DASH, MSE).\n` +
                    `📥 Скачать: https://github.com/Vidrimers/Yaro-Video-Downloader-Extension/releases\n\n` +
